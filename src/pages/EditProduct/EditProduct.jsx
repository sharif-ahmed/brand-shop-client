...
const EditProduct = () => {
    ...
    const handleUpdateProduct = (event) => {
        ...
        fetch(`https://brand-shop-server-dw8vl5gg3-sharif-ahmeds-projects.vercel.app/products/${id}`, requestOptions)
            .then((res) => res.json())
            .then((data) => {
                console.log(data);
                if (data.matchedCount > 0) {
                    ...
                    setProduct({});
                    form.productType.selected = 0;
                    form.productRating.selected = 0;
                    form.brandName.selected = 0;
                    form.reset();
                    navigate("/shop");
                }
            })
            ...
            <div className="border rounded-md p-4 lg:p-8">
                <div className='mx-auto'>
                    <h3 className="text-center uppercase text-[#1b1b1b] tracking-wide
                            ...
                            after:absolute after:w-[4px] mb-4">Update Product Information</h3>
                        ...
                        <form onSubmit={handleUpdateProduct}>
                            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between mb-5">
                                <div className="form-control lg:flex-1 w-full">
                                    ...
                                    <input defaultValue={productName} name='productName' type="text" placeholder="Product Name" className="input input-bordered outline-none" required />
                                </div>
                                {/* <div className="form-control lg:flex-1 w-full">
                                    <label className="label">
                                ...
                                <div className="form-control lg:flex-1 w-full">
                                    ...
                                    <select value={brandName} name='brandName' className="input input-bordered pr-11">
                                        <option value="" disabled
                                            selected className="py-1">Select Brand</option>
                            ...
                            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between mb-5">
                                <div className="form-control lg:flex-1 w-full">
                                    ...
                                    <input defaultValue={productImage} name='productImage' type="text" placeholder="Product Image Url" className="input input-bordered outline-none" required />
                                </div>
                                <div className="form-control lg:flex-1 w-full">
                                    <label className="label">
                                    ...
                                    {/* <input name='productType' type="text" placeholder="Product Type" className="input input-bordered" required /> */}
                                    <select value={productType} name='productType' className="input input-bordered pr-11">
                                        <option value="" disabled
                                            selected className="py-1">Select Type</option>
                            ...
                            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between mb-5">
                                <div className="form-control lg:flex-1 w-full">
                                    ...
                                    <input defaultValue={productPrice} name='productPrice' type="text" placeholder="Product Price" className="input input-bordered outline-none" required />
                                </div>
                                <div className="form-control lg:flex-1 w-full">
                                    <label className="label">
                                    ...
                                    <select value={productRating} name='productRating' className="input input-bordered">
                                        <option value="" disabled
                                            selected className="py-1">Select Rating</option>
                            ...
                            <div className="flex gap-4 items-center justify-between mb-5">
                                <div className="form-control flex-1 w-full">
                                    ...
                                    <textarea defaultValue={productDescription} name="productDescription" placeholder="Description" className="input input-bordered outline-none h-[30vh] pt-4" required />
                                </div>
                            ...
                            <div className="form-control mt-12">
                                <button type="submit" className="uppercase tracking-widest
                                        ...
                                        border-[#1b1b1b] text-[#1b1b1b]  hover:bg-[#d22e2e]
                                         hover:border-[#d22e2e]
                                        hover:transition ease-in-out">Update Product</button>
                            </div>
                        </form>
                    </div>
                </div>
